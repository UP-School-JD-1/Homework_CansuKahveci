...
public class PredicateCompositionExample {
	...
	public static void main(String[] args) {
		...
		Predicate<Integer> isEven2Not = Predicate.not(isEven);
		System.out.println("is 6 not even?: " + isEven2Not.test(6));
		...
		System.out.println(longerOrShorterThanPredicate.test("Çekoslovakyalılaştırdıklarımızdan mısınız", 40));
	}
}
