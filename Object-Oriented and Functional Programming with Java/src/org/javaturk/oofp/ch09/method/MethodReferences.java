...
//		bookconsumer3.accept(book1);
		...
		BinaryOperator<String> binaryGreeting = (x, y) -> x.concat(y);
		System.out.println(binaryGreeting.apply("Selam ", "abi :)"));
...
//		System.out.println(aSupplier.get().i);
		...
		A a = new A(5);
		Consumer<Boolean> aConsumer = a::f1;
		aConsumer.accept(true);
